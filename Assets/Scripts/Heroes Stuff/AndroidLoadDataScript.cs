...
public class AndroidLoadDataScript : MonoBehaviour {
	...
	void OnEnable () {
        ...
        if (m_joystick != null)
        {
            ...
            m_joystick.GetComponent<RectTransform>().anchoredPosition = new Vector3(MySQLiteHandler.instance.getFloat(m_SQLiteTable, zeJoystickStr + "X", null)
        ...
        if (m_attackButton != null)
        {
            ...
            m_attackButton.GetComponent<RectTransform>().anchoredPosition = new Vector3(MySQLiteHandler.instance.getFloat(m_SQLiteTable, zeAttackStr + "X", null)
        ...
        if (m_rangeButton != null)
        {
            ...
            m_rangeButton.GetComponent<RectTransform>().anchoredPosition = new Vector3(MySQLiteHandler.instance.getFloat(m_SQLiteTable, zeRangeStr + "X", null)
        ...
        if (m_InventoryButton != null)
        {
            ...
            m_InventoryButton.GetComponent<RectTransform>().anchoredPosition = new Vector3(MySQLiteHandler.instance.getFloat(m_SQLiteTable, zeInventoryStr + "X", null)
                , MySQLiteHandler.instance.getFloat(m_SQLiteTable, zeInventoryStr + "Y", null), 0);
        }
        if (m_PauseButton != null)
        {
            string zePauseStr = "PauseButtonPos";
            m_PauseButton.GetComponent<RectTransform>().anchoredPosition = new Vector3(MySQLiteHandler.instance.getFloat(m_SQLiteTable, zePauseStr + "X", null)
